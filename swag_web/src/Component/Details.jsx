...
function Details() {
  return (
    <div className="list-data">
      <h6 className="headings">Top Stories:Brand Directory</h6>
      <h5 className="sub-heading">MOST SEARCHED FOR ON FLIPKART:</h5>
      <p id="list-paragraphs">
        Google Pixel, 6Avivo T1XOPPO, Reno8 5GOPPO, Reno8 Pro, 5GNothing, Phone,
        1Sell Old Mobile PhonesASUS, TUF Gaming F15 Core, i5 10th
        GenElectronics, StoreOPPO A16KVivo, Y33TOPPO Reno7, 5GBathroom, Exhaust
        FanSamsung ,Window ACOPPO Reno7, Pro 5GiPhone, 13iPhone ,13 ProiPhone
        ,13 Pro MaxiPhone, 13 MiniFlipkart ,QuickBooksFlipkart, Help
        CentreOnline, <br /> Boat StoreFlipkart, Track OrdersFlipkart, Manage
        OrdersFlipkart, Return OrdersFlipkart Gift, Cards StoreFlipkart, Axis
        Bank, Credit CardFlipkart, Pay Later, MOBILES:iPhone, 12 64GBiPhone 12
        Pro, 512GBiPhone 12 128GBVivo ,Y91iVivo Y11Vivo ,Y15Vivo <br /> Y50Vivo
        ,Y12Reno2 FOppo A12Oppo, F15Oppo A31Samsung, A71Samsung, A51Samsung
        A31Realme ,X2iPhone 11iPhone ,11 ProiPhone 11, Pro MaxMobile
        ,Offersiphone x4G MobileNokia, MobileSamsung, MobileiphoneOppo,
        MobileVivo, CAMERA:GoPro Action CameraNikon ,CameraCanon CameraSony,
        CameraCanon, DSLRNikon DSLR, LAPTOPS:MacBook Pro M2acer, Ryzen 3 Dual
        Core, 3250U - (8 GB/256 GB SSD/Windows 11 Home), Z2-493 Thin and Light,
        LaptopASUS, Vivobook S14 OLED (2022)ASUS Zenbook 14 OLED (2022)Realme,
        Book Prime <br /> Core i5, 11th GenMicrosoft, Surface Go Pentium
        128GBBranded, LaptopsApple, LaptopsAcer LaptopsLenovo, LaptopsDell
        LaptopsAsus, LaptopsHP LaptopsGaming ,Laptops2 in 1 LaptopsLaptopsDell,
        latest <br />
        laptops 2022HP, latest laptops, 2022Infinix ,INBook X1 Neo Series
        ,Celeron Quad ,Core - (8 GB/256 GB SSD/Windows 11 Home), XL22 Thin and
        Light Laptop, TVS:Nokia TVPanasonic ,TVThomson TVVu TVRealme ,TVMotorola
        TVOnePlus ,TVsLG TVTVSony, TVSamsung ,TVAndroid TelevisionIffalcon, TvMi
        TV LARGE <br /> APPLIANCES:TV & Appliances ,End of Season
        SaleTelevisionWashing, MachinesRefrigeratorsAir ConditionersElectric,
        CookersElectric Jug(Heater) / Travel, KettlesInduction
        ,CooktopsInverters / stabilizerIrons / Iron BoxMixer Grinder JuicerWet,
        GrindersChimneysMicrowave, OvensVacuum CleanersWater PurifierFanMarQ
        Customer, Care CLOTHING:Men, <br /> ShirtsKurta PajamaKurtasMen
        T-ShirtsJeansSareeDressesKids, DressesDesigner, Salwar SuitsBraDesigner,
        KurtisTrack <br /> ,PantMen KurtasGym ,WearParty DressesPalazzo,
        SuitsBoys ClothingGlovesNightyMaxi, DressesAnarkaliGownsCulottesSalwar,
        SuitsKurtisDesigner SareesLeggingsShortsGeorgette SareesEthnic
        WearBriefs & TrunksNike, WatchesAscot TieCorset Tops TunicsLeather PU
        SkirtsCorset tops, camisolesWomen magenta <br /> earringsNo collar
        jacketsGreen dress materialBlack patiala ,kurta setMen, camel shoes
        casualBlack pathaniWallets slingKhaki dressesKids formal, dressesMauve
        ...
        CleanerHarpic Toilet, CleanerDettol SoapMustard <br />
        OilBiscuitsCheesePatanjali AttaFortune, OilAashirvaad AttaTea BEST,
        SELLING <br /> ON ,FLIPKART:Panasonic Side, by Side RefrigeratorBest Gas
        GeyserKitchen ,GeyserNutri, <br /> BlendersPortable, Air CoolerBest Air
        ...
        WatchesWalletsEarringsGold, <br /> CoinsRealme Pad MiniHandbagsconekt
        SW2 <br /> SmartwatchMivi, DuoPods, a350Speaker ,Cleaner <br />
        FURNITURE:FurnitureSofasBedsDining, setsWardrobesMattressesTV
        UnitsTablesChairsShelvesBean ,BagsOffice, <br /> ChairsComputer
        TableOffice TablesRed <br /> SofaWakefit BedsWhite SofaWakefit
        ,MattressGreen SofaBlack SofaBrown ,Sofa BGMH:Whey ProteinHomeopathyKids
        ,CameraToysRusOnline GuitarBooks, StoreMusical Instrument StoreEnergy
        DrinksToysMilk Drink MixesRakhiProtein ,Supplements
      </p>
      <br />
      <br />
      <h1 className="second-list-heading">
      ...
      <h1 className="second-list-heading">Flipkart Plus</h1>
      <p className="second-parah">
      ...
      <p className="second-parah">
        ...
        https://www.flipkart.com/plus/all-offers for the entire list. Terms and
        conditions apply.
      </p>
      <p className="second-parah">
        What's more, you can even use the Flipkart supercoins for a number of
      ...
      <h1 className="second-list-heading">No Cost EMI</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">EMI on Debit Cards</h1>
      <p className="second-parah">
        In an attempt to make high-end products accessible to all, our No Cost
        EMI plan enables you to shop with us under EMI, without shelling out any
        processing fee. Applicable on select mobiles, laptops, large and small
      ...
      <h1 className="second-list-heading">Mobile Exchange Offers</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">What Can You Buy From Flipkart?</h1>

      <h1 className="second-list-heading">Mobile Phones</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">Large Appliances</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">Small Home Appliances</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">Lifestyle</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">Home and Furniture</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">Baby and Kids</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">Books, Sports and Games</h1>
      <p className="second-parah">
      ...
      <h1 className="second-list-heading">Grocery/Supermart</h1>
      <p className="second-parah">
